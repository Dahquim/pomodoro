...
export default function PomodoroOptions({ sessionLength, handleSessionChange, breakLength, handleBreakChange }: PomodoroOptionsProps) {
    return (
        <div id="options" className="flex gap-4 py-12">
            <div className="flex flex-col space-y-2">
                <span className="text-secondary font-bold uppercase">Session Length</span>
                <div>
            ...
            <div className="flex flex-col space-y-2">
                <span className="text-secondary font-bold uppercase">Break Length</span>
                <div>
